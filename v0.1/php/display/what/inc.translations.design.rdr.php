...
echo '			<line id="translation_'.$row_translations['id'].'_a" x1="'.$x1_source1.'%" y1="'.$y1_source1.'%" x2="'.$x1_destination1.'%" y2="'.$y1_destination1.'%" style="fill:none; stroke:'.$stroke.'; stroke-width:0.5; stroke-opacity:0.5; stroke-dasharray:1,1,1,1; marker-end:url(#Triangle);"/>'."\n";
if ($row_translations['interfaceways_name'] == 'external') $stroke_dasharray = ' stroke-dasharray:8,4,2,4;';
echo '			<line id="translation_'.$row_translations['id'].'_c" x1="'.$x_interface2.'%" y1="'.$y_interface2.'%" x2="'.$x1_forward1.'%" y2="'.$y1_forward1.'%" style="fill:none; stroke:'.$stroke.'; stroke-width:1;'.$stroke_dasharray.' marker-end:url(#Triangle);"/>'."\n";
